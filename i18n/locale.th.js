...
window.MYOB_LOCALES.th = {
  ...
  "ui": {
    ...
    "usNotice": {
      ...
      "body": "คู่มือนี้อธิบายการฝากครรภ์ตามที่ให้บริการในสหรัฐอเมริกา และเขียนขึ้นสำหรับคุณแม่ที่รับการดูแลที่นี่ การฝากครรภ์แตกต่างกันมากในแต่ละประเทศ กำหนดการนัดตรวจ การตรวจต่าง ๆ และคำแนะนำในที่อื่นอาจไม่ตรงกับที่อ่านในคู่มือนี้ หากคุณรับการดูแลในประเทศอื่น โปรดปฏิบัติตามคำแนะนำของทีมผู้ดูแลของคุณ",
      "continue": "เข้าใจแล้ว"
    }
  }
};
