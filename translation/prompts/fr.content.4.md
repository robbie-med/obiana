...
pregnancy and childbirth guide, from English into French (Français).
...
the KEY SET with the plural categories French actually uses (CLDR
...
title/sub/body — to:
translation/out/fr.content.4.json
